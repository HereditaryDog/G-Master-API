...
import (
	...
	_ "github.com/yangjunyu/G-Master-API/setting/performance_setting"
...
func main() {
	...
	common.SysLog("G-Master API " + common.Version + " started")
...
func InjectUmamiAnalytics() {
	...
	analyticsInjectBuilder.WriteString("<!--Umami G-Master API-->\n")
...
func InjectGoogleAnalytics() {
	...
	analyticsInjectBuilder.WriteString("<!--Google Analytics G-Master API-->\n")
	analyticsInject := analyticsInjectBuilder.String()
