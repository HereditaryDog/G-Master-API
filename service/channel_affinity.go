...
const (
	...
	channelAffinityCacheNamespace           = "g-master-api:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "g-master-api:channel_affinity_usage_cache_stats:v1"
)
