...
func truncate(t *testing.T) {
	...
	t.Cleanup(func() {
		...
		model.DB.Exec("DELETE FROM gaster_code_auth_requests")
		model.DB.Exec("DELETE FROM gaster_code_sessions")
		model.DB.Exec("DELETE FROM gaster_code_billing_checkouts")
	})
}
