...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-g-master-api-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-g-master-api-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-g-master-api-container') return true;
      return (
